...
public class UserController {
	...
	@RequestMapping(value = "/per/pass/{userId}", method = RequestMethod.GET)
	public String preChangePass(@PathVariable(value = "userId") String userId,Map<String, Object> map) {
            map.put("userId", userId);
		return "/user/changepass";
	}
	@RequestMapping(value = "/per/pass/{userId}", method = RequestMethod.POST)
	public String changePass(@PathVariable(value = "userId") String userId,@RequestParam(value="prepassword") String prepassword,@RequestParam(value="newpassword") String newpassword) {
	...
	@RequestMapping(value = "/per/info/{id}", method = RequestMethod.GET)
	public String getUserInfo(@PathVariable(value = "id") Integer id,Map<String, Object>map) {
