            	...
            	<div class="the_content">
                	...
                	<table class="tableHue2" width="100%" border="1" bordercolor="#dddddd" cellspacing="0" cellpadding="0" >
                      ...
                      <form:form modelAttribute="user">
                        <tr>
                          <td width="15%" class="title1">账户名：</td>
                          <td class="left"><form:input path= "account" type="text" id="account" size="30" /></td>
                        </tr>
                        <tr>
                          <td width="15%" class="title1">用户名称：</td>
                          <td class="left"><form:input path= "userName" type="text" class="input_text2" size="30" /></td>
                        </tr>
                        <tr>
                          <td width="15%" class="title1">密码：</td>
                          <td class="left"><form:input path= "password" type="text" class="input_text2" size="30" /></td>
                        </tr>
                        
                        <tr>
                          <td width="15%" class="title1">电话：</td>
                          <td class="left"><form:input path= "telephone" type="text" class="input_text2" size="30" /></td>
                        </tr>
                        </form:form>
                      </tbody>
                  </table>
